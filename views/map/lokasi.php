...
$this->title = 'Map Luas Lahan Petani Bawang';
...
<div class="row">
        <div class="col-md-12">
            <div class="box box-solid">
                <div class="box-body">
                    <h3><i class="fa fa-map"></i> <?= Html::encode($this->title) ?><span style="margin-left:15px;"><?= Html::a('<i class="fa fa-plus"></i> Lokasi', ['create'], ['class' => 'btn btn-success']) ?></span></h3>
...
function initialize() {
  ...
  coba.forEach(function(element,index){
      ...
      content:element.nama+", Luas Lahan : "+ hektar +" Hektar"
